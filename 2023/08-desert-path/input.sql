drop table if exists aoc.instructions;
drop table if exists aoc.network;

create table aoc.instructions as
select
    row_number() over (),
    dir
...
create table aoc.network (row_number, node, "left", "right") as
select
    row_number() over (),
    node,
    "left",
