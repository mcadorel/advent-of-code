...
create table if not exists aoc.seeds                   (seed bigint);
create table if not exists aoc.seed_to_soil        (source_range int8range, "offset" bigint);
create table if not exists aoc.soil_to_fertilizer      (source_range int8range, "offset" bigint);
create table if not exists aoc.fertilizer_to_water     (source_range int8range, "offset" bigint);
create table if not exists aoc.water_to_light          (source_range int8range, "offset" bigint);
create table if not exists aoc.light_to_temperature    (source_range int8range, "offset" bigint);
create table if not exists aoc.temperature_to_humidity (source_range int8range, "offset" bigint);
create table if not exists aoc.humidity_to_location    (source_range int8range, "offset" bigint);

insert into aoc.seeds (seed) values
    (364807853), (408612163), (302918330), (20208251), (1499552892), (200291842), (3284226943), (16030044),
    (2593569946), (345762334), (3692780593), (17215731), (1207118682), (189983080), (2231594291), (72205975),
    (3817565407), (443061598), (2313976854), (203929368)
;

insert into aoc.seed_to_soil (source_range, "offset")
select
    int8range(
        source_start,
        source_start + length + 1
    ) as source_range,
    target_start - source_start as "offset"
from (values
...
) input (target_start, source_start, length)
;

insert into aoc.soil_to_fertilizer (source_range, "offset")
select
    int8range(
        source_start,
        source_start + length + 1
...
insert into aoc.fertilizer_to_water (source_range, "offset")
select
    int8range(
        source_start,
        source_start + length + 1
...
insert into aoc.water_to_light (source_range, "offset")
select
    int8range(
        source_start,
        source_start + length + 1
...
insert into aoc.light_to_temperature (source_range, "offset")
select
    int8range(
        source_start,
        source_start + length + 1
...
insert into aoc.temperature_to_humidity (source_range, "offset")
select
    int8range(
        source_start,
        source_start + length + 1
...
insert into aoc.humidity_to_location (source_range, "offset")
select
    int8range(
        source_start,
        source_start + length + 1
